...
>
    ...
    <div  style="margin:0px auto;max-width:600px;">
        ...
        >
            ...
            <tr>
                <td
                        style="direction:ltr;font-size:0px;padding:5px;text-align:center;"
                >
                                    ...
                                    >
                                        ...
                                        <tr>
                                            <td  style="width:160px;">
                                                ...
                                                <img
                                                        height="auto" src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/Exadel_logo.png/1200px-Exadel_logo.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="160"
                                                />
    ...
    <div  style="margin:0px auto;max-width:600px;">
        ...
        >
            ...
            <tr>
                <td
                        style="border:2px solid #eee;direction:ltr;font-size:0px;padding:20px 0;text-align:center;"
                >
                    <!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="" style="vertical-align:top;width:298px;" ><![endif]-->
                        ...
                        >
                            ...
                            <tr>
                                ...
                                >
                                    ...
                                    <div
                                            style="font-family:Roboto;font-size:13px;line-height:1;text-align:center;color:black;"
                                    ><h2>Don't know what you want?</h2>
                                        In your's subscriptions appears new proposal: <#list discounts as discount>
                                            ${discount}<#sep>,
                                        </#list>.</div>
                            ...
                            <tr>
                                ...
                                >
                                    ...
                                    >
                                        <tr>
                                            <td
                                                    align="center" bgcolor="#0d6efd" role="presentation" style="border:none;border-radius:3px;cursor:auto;mso-padding-alt:10px 25px;background:#0d6efd;" valign="middle"
                                            >
                                                <a
                                                        href="https://exadel-discounts-5.herokuapp.com/login" style="display:inline-block;background:#0d6efd;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:3px;" target="_blank"
                                                >
                                                    Order  now
                                                </a>
                                            </td>
                    ...
                    <!--[if mso | IE]></td><td class="" style="vertical-align:top;width:298px;" ><![endif]-->
                                    ...
                                    >
                                        ...
                                        <tr>
                                            <td  style="width:200px;">
                                                ...
                                                <img
                                                        height="auto" src="https://cms-assets.tutsplus.com/cdn-cgi/image/width=630/uploads/users/23/posts/28611/image/how-to-set-discount-pricing-right.jpg" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="200"
                                                />
